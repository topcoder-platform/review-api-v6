...
export const mockProjectResultResponseDto: ProjectResultResponseDto = {
  ...
  pointAdjustment: -2.5,
  ratingOrder: 5,
  createdAt: new Date('2025-02-11T12:34:56.789Z'),
  createdBy: 'admin-user',
  updatedAt: new Date('2025-02-12T14:23:45.678Z'),
